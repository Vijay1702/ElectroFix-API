...
## 32. Complete Prisma Schema Reference
...
|---|-------|-------|-----------|
| 1 | Role | roles | → User (1:N) |
| 2 | User | users | → Role, → RepairJob, → Payment, → Invoice, → Notification |
| 3 | Customer | customers | → RepairJob (1:N), → Invoice (1:N) |
| 4 | RepairJob | repair_jobs | → Customer, → User, → RepairStatusHistory, → Invoice |
| 5 | RepairStatusHistory | repair_status_history | → RepairJob, → User |
| 6 | Category | categories | → Product (1:N) |
| 7 | Product | products | → Category, → InvoiceItem, → StockMovement |
| 8 | StockMovement | stock_movements | → Product, → User |
| 9 | Invoice | invoices | → Customer, → RepairJob, → User, → InvoiceItem, → Payment |
| 10 | InvoiceItem | invoice_items | → Invoice, → Product |
| 11 | Payment | payments | → Invoice, → User |
| 12 | Setting | settings | standalone |
| 13 | Notification | notifications | → User |
| 14 | FileUpload | file_uploads | standalone (polymorphic) |
